...
#######################################################################################
# Copy dataproducts incremental backup files from dp-mysql-data-02 to backup-master01.
# This is a data pull.
# This script is called by root cron job scheduled to run
# every day 2 hours after dataproducts incremental backup cronjob on  dp-mysql-data-02
########################################################################################
# Version: 1.0
# Developer: Indu N
########################################################################################
...
LOG_PATH="/dataproducts/log/INCR_COPY_$(date +%a%Y%m%d).log"
