...
PIP_PACKAGES="request dbutils scipy numpy matplotlib pandas statsmodels scikit-learn theano tensorflow keras plotly seaborn horovod pyocr pillow scrapy dialogflow apiai h5py spark-sklearn tensorflowonspark"
